...
class JwtProcessorTest {
  ...
  void getUsername() {
    //  실제 테스트에서 생성된 토큰 사용
    String token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyMCIsImlhdCI6MTc1MDgzMDE0MSwiZXhwIjoxNzUwODMwNDQxfQ.bVwd3X4ZDAWNjMzzMiXGAhJXmDR6q6C8GIEFyjN_6x8";
  ...
  void validateToken_Expired() {
    String expiredToken = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyMCIsImlhdCI6MTc1MDgzMDE0MSwiZXhwIjoxNzUwODMwNDQxfQ.bVwd3X4ZDAWNjMzzMiXGAhJXmDR6q6C8GIEFyjN_6x8";
